...
struct _ESERVERSILO_GLOBALS
{
    ...
    struct _EX_TIMEZONE_STATE* ExTimeZoneState;                             //0x264
    struct _UNICODE_STRING NtSystemRoot;                                    //0x268
    struct _UNICODE_STRING SiloRootDirectoryName;                           //0x270
    struct _PSP_STORAGE* Storage;                                           //0x278
    enum _SERVERSILO_STATE State;                                           //0x27c
    LONG ExitStatus;                                                        //0x280
    struct _KEVENT* DeleteEvent;                                            //0x284
    struct _SILO_USER_SHARED_DATA* UserSharedData;                          //0x288
    VOID* UserSharedSection;                                                //0x28c
    struct _WORK_QUEUE_ITEM TerminateWorkItem;                              //0x290
    UCHAR IsDownlevelContainer;                                             //0x2a0
};
/* Used in */
// _EJOB
