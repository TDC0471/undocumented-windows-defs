...
struct _KPRCB
{
    ...
    ULONG CoresPerPhysicalProcessor;                                        //0x340
    ULONG LogicalProcessorsPerCore;                                         //0x344
    ULONG KernelReserved[12];                                               //0x348
    ULONG HalReserved[16];                                                  //0x378
    ULONG CFlushSize;                                                       //0x3b8
    UCHAR LegacyCoresPerPhysicalProcessor;                                  //0x3bc
    UCHAR LegacyLogicalProcessorsPerCore;                                   //0x3bd
    ...
    union
    {
        ...
        struct
        {
            ...
            UCHAR BpbFlushRsbOnReturn:1;                                    //0x21b8
            UCHAR BpbReserved:3;                                            //0x21b8
        };
    };
    union
    {
    ...
    ULONG LogicalProcessorsPerPhysicalProcessor;                            //0x3d38
    UCHAR VendorString[13];                                                 //0x3d3c
    UCHAR InitialApicId;                                                    //0x3d49
    UCHAR PrcbPad9[2];                                                      //0x3d4a
