...
struct _MMPAGING_FILE
{
    ...
    ULONG NumberOfModWriterEntries;                                         //0x24
    ...
    USHORT BackedBySCM:1;                                                   //0x74
    USHORT SpecialPurposeMemory:1;                                          //0x74
    USHORT Spare0:3;                                                        //0x74
    ...
    volatile LONG SpinLock;                                                 //0x88
    struct _RTL_AVL_TREE FlowThroughReadRoot;                               //0x8c
    struct _MI_PARTITION* Partition;                                        //0x90
    struct _RTL_BALANCED_NODE FileObjectNode;                               //0x94
};
/* Used in */
