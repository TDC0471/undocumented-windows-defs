...
struct _IOP_IRP_EXTENSION
{
    ...
    union
    {
        ULONGLONG Value;                                                    //0x30
        ULONGLONG UserFlags:32;                                             //0x30
        ULONGLONG SystemFlags:16;                                           //0x30
        ULONGLONG UserFlagsId:16;                                           //0x30
    } DriverFlags;                                                          //0x30
    struct _COPY_INFORMATION CopyInformation;                               //0x38
};
