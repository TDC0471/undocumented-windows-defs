...
struct _MI_PARTITION
{
    ...
    struct _MI_PAGE_COMBINING_SUPPORT PageCombine;                          //0xe18
    VOID* WorkingSetControl;                                                //0xef8
    struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;           //0xefc
    ULONG SessionDetachTimeStamp;                                           //0xf04
