...
struct _DEVICE_NODE
{
    ...
    struct _UNICODE_STRING UniqueId;                                        //0x48
    struct _POP_FX_PLUGIN* Plugin;                                          //0x50
    ULONG Level;                                                            //0x54
    union _POWER_STATE CurrentPowerState;                                   //0x58
    struct _PO_DEVICE_NOTIFY Notify;                                        //0x5c
    struct _PO_IRP_MANAGER PoIrpManager;                                    //0x98
    volatile LONG PowerFlags;                                               //0xa8
    ...
    struct _PNP_REBALANCE_TRACE_CONTEXT* RebalanceContext;                  //0x1cc
    struct _DEVICE_NODE_IOMMU_EXTENSION* IommuExtension;                    //0x1d0
    struct _PO_DIRECTED_DRIPS_STATE DirectedDripsState;                     //0x1d4
};
/* Used in */
// _DEVICE_NODE
