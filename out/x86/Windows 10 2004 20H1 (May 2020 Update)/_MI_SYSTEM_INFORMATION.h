...
struct _MI_SYSTEM_INFORMATION
{
    ...
    struct _MI_COMMON_PAGE_STATE CommonPages;                               //0x40e0
    struct _MI_SYSTEM_TRIM_STATE Trims;                                     //0x4140
    struct _MI_ENCLAVE_STATE Enclaves;                                      //0x4180
    ULONG Cookie;                                                           //0x41a4
    VOID* volatile* BootRegistryRuns;                                       //0x41a8
    volatile LONG ZeroingDisabled;                                          //0x41ac
    UCHAR FullyInitialized;                                                 //0x41b0
    UCHAR SafeBooted;                                                       //0x41b1
    struct _RTL_BITMAP PfnBitMap;                                           //0x41b4
    struct _tlgProvider_t* TraceLogging;                                    //0x41bc
    struct _MI_VISIBLE_STATE Vs;                                            //0x41c0
};
