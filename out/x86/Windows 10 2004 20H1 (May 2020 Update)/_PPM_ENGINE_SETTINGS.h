...
struct _PPM_ENGINE_SETTINGS
{
    ...
    UCHAR HeteroDecreaseThreshold[32];                                      //0xa1
    UCHAR HeteroIncreaseThreshold[32];                                      //0xc1
    UCHAR Class0FloorPerformance;                                           //0xe1
    UCHAR Class1InitialPerformance;                                         //0xe2
    enum _KHETERO_CPU_POLICY ThreadPolicies[2];                             //0xe4
};
/* Used in */
// _POP_PPM_PROFILE
