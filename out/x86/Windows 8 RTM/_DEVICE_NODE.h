...
struct _DEVICE_NODE
{
    ...
    ULONG Level;                                                            //0x28
    union _POWER_STATE CurrentPowerState;                                   //0x2c
    struct _PO_DEVICE_NOTIFY Notify;                                        //0x30
    struct _PO_IRP_MANAGER PoIrpManager;                                    //0x6c
    struct _POP_FX_DEVICE* FxDevice;                                        //0x7c
    volatile LONG FxDeviceLock;                                             //0x80
    struct _KEVENT FxRemoveEvent;                                           //0x84
    volatile LONG FxActivationCount;                                        //0x94
    volatile LONG FxSleepCount;                                             //0x98
    struct _POP_FX_PLUGIN* Plugin;                                          //0x9c
