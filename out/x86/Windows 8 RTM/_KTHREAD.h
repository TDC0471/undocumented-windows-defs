...
struct _KTHREAD
{
    ...
    union
    {
        struct
        {
            ...
            ULONG CodePatchInProgress:1;                                    //0x58
    ...
    struct _KQUEUE* volatile Queue;                                         //0xa4
    VOID* Teb;                                                              //0xa8
    ...
    volatile ULONG DeferredProcessor;                                       //0x14c
    struct _KPROCESS* Process;                                              //0x150
    union
    {
        volatile struct _GROUP_AFFINITY UserAffinity;                       //0x154
        struct
        {
    ...
    union
    {
        volatile struct _GROUP_AFFINITY Affinity;                           //0x160
        struct
        {
