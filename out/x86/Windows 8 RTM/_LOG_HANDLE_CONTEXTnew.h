...
struct _LOG_HANDLE_CONTEXT
{
    ...
    ULONG AdditionalPagesToWrite;                                           //0x28
    ULONG CcLWScanDPThreshold;                                              //0x2c
    union _LARGE_INTEGER LargestLsnForCurrentLWScan;                        //0x30
    struct _FILE_OBJECT* RelatedFileObject;                                 //0x38
    ULONG LargestLsnFileObjectKey;                                          //0x3c
    union _LARGE_INTEGER LastLWTimeStamp;                                   //0x40
    ULONG Flags;                                                            //0x48
};
/* Used in */
