...
struct _KALPC_MESSAGE
{
    ...
    VOID* DataSystemVa;                                                     //0x58
    struct _ALPC_COMMUNICATION_INFO* CommunicationInfo;                     //0x5c
    struct _ALPC_PORT* ConnectionPort;                                      //0x60
    struct _ETHREAD* ServerThread;                                          //0x64
    VOID* WakeReference;                                                    //0x68
    VOID* ExtensionBuffer;                                                  //0x6c
    ULONG ExtensionBufferSize;                                              //0x70
