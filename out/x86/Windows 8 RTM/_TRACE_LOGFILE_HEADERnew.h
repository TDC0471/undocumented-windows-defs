...
struct _TRACE_LOGFILE_HEADER
{
    ...
    USHORT* LoggerName;                                                     //0x38
    USHORT* LogFileName;                                                    //0x3c
    struct _RTL_TIME_ZONE_INFORMATION TimeZone;                             //0x40
    union _LARGE_INTEGER BootTime;                                          //0xf0
    union _LARGE_INTEGER PerfFreq;                                          //0xf8
    union _LARGE_INTEGER StartTime;                                         //0x100
    ULONG ReservedFlags;                                                    //0x108
    ULONG BuffersLost;                                                      //0x10c
};
