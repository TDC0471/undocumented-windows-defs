...
struct _POP_FX_DEVICE
{
    ...
    VOID* DriverContext;                                                    //0x58
    struct _LIST_ENTRY AcpiLink;                                            //0x5c
    struct _UNICODE_STRING DeviceId;                                        //0x64
    struct _IO_REMOVE_LOCK RemoveLock;                                      //0x6c
    struct _IO_REMOVE_LOCK AcpiRemoveLock;                                  //0x84
    struct _POP_FX_WORK_ORDER WorkOrder;                                    //0x9c
    ULONG IdleLock;                                                         //0xb8
