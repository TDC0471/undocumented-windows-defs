...
struct _KTHREAD
{
    ...
    union
    {
        struct
        {
            ...
            ULONG ThreadFlagsSpare0:1;                                      //0x5c
            ...
            ULONG CommitFailTerminateRequest:1;                             //0x5c
            ULONG ProcessStackCountDecremented:1;                           //0x5c
            ULONG ThreadFlagsSpare:5;                                       //0x5c
    ...
    volatile SHORT KeReferenceCount;                                        //0x328
    UCHAR AbOrphanedEntrySummary;                                           //0x32a
    UCHAR AbOwnedEntryCount;                                                //0x32b
