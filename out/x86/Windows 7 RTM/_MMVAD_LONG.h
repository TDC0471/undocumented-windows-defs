...
struct _MMVAD_LONG
{
    ...
    struct _LIST_ENTRY ViewLinks;                                           //0x30
    struct _EPROCESS* VadsProcess;                                          //0x38
    union
    {
        struct _LIST_ENTRY List;                                            //0x3c
        struct _MMADDRESS_LIST Secured;                                     //0x3c
    } u3;                                                                   //0x3c
    union
    {
        struct _MMBANKED_SECTION* Banked;                                   //0x44
