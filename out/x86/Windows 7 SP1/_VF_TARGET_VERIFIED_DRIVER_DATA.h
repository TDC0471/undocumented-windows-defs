...
struct _VF_TARGET_VERIFIED_DRIVER_DATA
{
    ...
    volatile ULONG PeakPagedPoolAllocations;                                //0x30
    volatile ULONG PeakNonPagedPoolAllocations;                             //0x34
    volatile ULONG PagedBytes;                                              //0x38
    volatile ULONG NonPagedBytes;                                           //0x3c
    volatile ULONG PeakPagedBytes;                                          //0x40
    volatile ULONG PeakNonPagedBytes;                                       //0x44
