...
struct _MI_PARTITION
{
    ...
    struct _MI_PARTITION_COMMIT Commit;                                     //0x1000
    struct _MI_PARTITION_ZEROING Zeroing;                                   //0x1080
    struct _MI_PAGE_COMBINING_SUPPORT PageCombine;                          //0x10c0
    VOID* WorkingSetControl;                                                //0x11a0
    struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;           //0x11a4
    ULONG SessionDetachTimeStamp;                                           //0x11ac
    struct _MI_VISIBLE_PARTITION Vp;                                        //0x11c0
};
/* Used in */
