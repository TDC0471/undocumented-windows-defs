...
struct _ARBITER_INSTANCE
{
    ...
    LONG (*DeleteOwnerRanges)(struct _ARBITER_INSTANCE* arg1, VOID* arg2);  //0x90
    UCHAR TransactionInProgress;                                            //0x94
    struct _KEVENT* TransactionEvent;                                       //0x98
    VOID* Extension;                                                        //0x9c
    struct _DEVICE_OBJECT* BusDeviceObject;                                 //0xa0
    VOID* ConflictCallbackContext;                                          //0xa4
    UCHAR (*ConflictCallback)(VOID* arg1, struct _RTL_RANGE* arg2);         //0xa8
};
/* Used in */
// _ARBITER_INSTANCE
