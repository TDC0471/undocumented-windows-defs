...
struct _PPM_PLATFORM_STATES
{
    ...
    LONG (*IdlePreExecute)(VOID* arg1, ULONG arg2, ULONG arg3, ULONG arg4, ULONG* arg5); //0x14
    VOID (*IdleComplete)(VOID* arg1, ULONG arg2, ULONG arg3, ULONG arg4, ULONG* arg5); //0x18
    LONG (*QueryPlatformStateResidency)(VOID* arg1, struct _PROCESSOR_PLATFORM_STATE_RESIDENCIES* arg2); //0x1c
    struct _PLATFORM_IDLE_ACCOUNTING* Accounting;                           //0x20
    UCHAR DeepSleepEnabled;                                                 //0x24
