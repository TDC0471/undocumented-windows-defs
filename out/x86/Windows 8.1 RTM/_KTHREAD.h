...
struct _KTHREAD
{
    ...
    union
    {
        struct
        {
            ULONG KernelStackResident:1;                                    //0x58
            ULONG ReadyTransition:1;                                        //0x58
            ULONG ProcessReadyQueue:1;                                      //0x58
            ...
            ULONG ApcPendingReload:1;                                       //0x58
            ULONG Reserved:13;                                              //0x58
        };
        LONG MiscFlags;                                                     //0x58
    };
    union
    ...
    union
    {
        struct _GROUP_AFFINITY Affinity;                                    //0x160
        struct
        {
            UCHAR AffinityFill[6];                                          //0x160
            UCHAR ApcStateIndex;                                            //0x166
            UCHAR WaitBlockCount;                                           //0x167
            ULONG IdealProcessor;                                           //0x168
        };
    };
    struct _KAPC_STATE* ApcStatePointer[2];                                 //0x16c
    union
    {
    ...
    struct _SINGLE_LIST_ENTRY LockEntriesFreeList;                          //0x1e4
    ...
    volatile SHORT AbReferenceCount;                                        //0x328
    UCHAR AbFreeEntryCount;                                                 //0x32a
    UCHAR AbWaitEntryCount;                                                 //0x32b
    ULONG ForegroundLossTime;                                               //0x32c
    union
    {
        struct _LIST_ENTRY GlobalForegroundListEntry;                       //0x330
        struct
        {
            struct _SINGLE_LIST_ENTRY ForegroundDpcStackListEntry;          //0x330
            ULONG InGlobalForegroundList;                                   //0x334
        };
    };
};
/* Used in */
