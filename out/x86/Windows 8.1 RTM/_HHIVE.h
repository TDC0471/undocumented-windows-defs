...
struct _HHIVE
{
    ...
    UCHAR LogDataPresent[2];                                                //0x6c
    UCHAR PrimaryFileValid;                                                 //0x6e
    UCHAR BaseBlockDirty;                                                   //0x6f
    union
    {
        struct
        {
            USHORT FirstLogFile:3;                                          //0x70
            USHORT SecondLogFile:3;                                         //0x70
            USHORT HeaderRecovered:1;                                       //0x70
            USHORT LegacyRecoveryIndicated:1;                               //0x70
            USHORT RecoveryInformationReserved:8;                           //0x70
        };
        USHORT RecoveryInformation;                                         //0x70
    };
    UCHAR LogEntriesRecovered[2];                                           //0x72
    ULONG RefreshCount;                                                     //0x74
    ULONG StorageTypeCount;                                                 //0x78
    ULONG Version;                                                          //0x7c
    struct _DUAL Storage[2];                                                //0x80
};
/* Used in */
// _CMHIVE
