...
struct _MM_SESSION_SPACE
{
    ...
    struct _MMWSLE* Wsle;                                                   //0xd60
    struct _MI_SESSION_DRIVER_UNLOAD DriverUnload;                          //0xd64
    ...
    ULONG PoolTrackTableExpansionSize;                                      //0x1f7c
    VOID* PoolTrackBigPages;                                                //0x1f80
    ULONG PoolTrackBigPagesSize;                                            //0x1f84
    enum _IO_SESSION_STATE IoState;                                         //0x1f88
    ULONG IoStateSequence;                                                  //0x1f8c
    struct _KEVENT IoNotificationEvent;                                     //0x1f90
};
