...
struct _DEBUG_DEVICE_DESCRIPTOR
{
    ...
    USHORT PortType;                                                        //0x80
    USHORT PortSubtype;                                                     //0x82
    VOID* OemData;                                                          //0x84
    ULONG OemDataLength;                                                    //0x88
    enum KD_NAMESPACE_ENUM NameSpace;                                       //0x8c
    WCHAR* NameSpacePath;                                                   //0x90
    ULONG NameSpacePathLength;                                              //0x94
    ULONG TransportType;                                                    //0x98
    struct _DEBUG_TRANSPORT_DATA TransportData;                             //0x9c
};
/* Used in */
