...
struct _MI_SYSTEM_VA_STATE
{
    ...
    struct _MI_HYPER_SPACE* PagableHyperSpace;                              //0x2648
    VOID* HyperSpaceEnd;                                                    //0x264c
    struct _KEVENT FreeSystemCacheVa;                                       //0x2650
    ULONG SystemVaLock;                                                     //0x2660
    ULONG SystemCacheViewLock;                                              //0x2664
    struct _MMWSL_INSTANCE SystemWorkingSetList[8];                         //0x2668
};
/* Used in */
