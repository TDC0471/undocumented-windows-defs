...
struct _POP_HIBER_CONTEXT
{
    ...
    VOID* FirmwareRuntimeInformationVa;                                     //0x98
    VOID* ResumeContext;                                                    //0x9c
    ULONG ResumeContextPages;                                               //0xa0
    ULONG ProcessorCount;                                                   //0xa4
    struct _POP_PER_PROCESSOR_CONTEXT* ProcessorContext;                    //0xa8
    CHAR* ProdConsBuffer;                                                   //0xac
    ULONG ProdConsSize;                                                     //0xb0
    ULONG MaxDataPages;                                                     //0xb4
    VOID* ExtraBuffer;                                                      //0xb8
    ULONG ExtraBufferSize;                                                  //0xbc
    VOID* ExtraMapVa;                                                       //0xc0
    ULONG BitlockerKeyPFN;                                                  //0xc4
    struct _POP_IO_INFO IoInfo;                                             //0xc8
    USHORT* IoChecksums;                                                    //0x128
    ULONG IoChecksumsSize;                                                  //0x12c
    ULONG HardwareConfigurationSignature;                                   //0x130
    UCHAR SecureBoot;                                                       //0x134
};
/* Used in */
// _POP_POWER_ACTION
