...
struct _PPM_ENGINE_SETTINGS
{
    ...
    UCHAR HeteroDecreaseThreshold[32];                                      //0x71
    UCHAR HeteroIncreaseThreshold[32];                                      //0x91
    UCHAR Class0FloorPerformance;                                           //0xb1
    UCHAR Class1InitialPerformance;                                         //0xb2
    enum _KHETERO_CPU_POLICY ThreadPolicies[2];                             //0xb4
};
/* Used in */
// _POP_PPM_PROFILE
