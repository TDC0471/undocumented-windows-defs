...
struct _KPRCB
{
    ...
    union
    {
        USHORT BpbState;                                                    //0x21b8
        struct
        {
            USHORT BpbIbrsPresent:1;                                        //0x21b8
            USHORT BpbStibpPresent:1;                                       //0x21b8
            USHORT BpbSmepPresent:1;                                        //0x21b8
            USHORT BpbSimulateSpecCtrl:1;                                   //0x21b8
            USHORT BpbSimulateIbpb:1;                                       //0x21b8
            USHORT BpbIbpbPresent:1;                                        //0x21b8
            USHORT BpbCpuIdle:1;                                            //0x21b8
            USHORT BpbClearSpecCtrlOnIdle:1;                                //0x21b8
            USHORT BpbHTDisabled:1;                                         //0x21b8
            USHORT BpbUserToUserOnly:1;                                     //0x21b8
            USHORT BpbReserved:6;                                           //0x21b8
        };
    };
    UCHAR BpbSpecCtrlValue;                                                 //0x21ba
    UCHAR BpbCtxSwapSetValue;                                               //0x21bb
    UCHAR PrcbPad50[20];                                                    //0x21bc
    ...
    ULONG DbgLogs[512];                                                     //0x4f08
    ULONG DbgCount;                                                         //0x5708
    ULONG PrcbPadRemaingPage[501];                                          //0x570c
