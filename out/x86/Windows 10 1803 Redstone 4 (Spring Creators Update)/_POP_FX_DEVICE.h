...
struct _POP_FX_DEVICE
{
    ...
    volatile ULONG Flags;                                                   //0x1c8
    ULONG ComponentCount;                                                   //0x1cc
    struct _POP_FX_COMPONENT** Components;                                  //0x1d0
    ULONG LogEntries;                                                       //0x1d4
    struct _POP_FX_LOG_ENTRY* Log;                                          //0x1d8
    volatile LONG LogIndex;                                                 //0x1dc
    struct _DRIVER_OBJECT* DripsWatchdogDriverObject;                       //0x1e0
    struct _POP_FX_DRIPS_WATCHDOG_CONTEXT DripsWatchdogContext;             //0x1e4
};
/* Used in */
// _DEVICE_NODE
// _POP_FX_COMPONENT
