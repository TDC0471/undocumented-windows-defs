...
struct _HAL_INTEL_ENLIGHTENMENT_INFORMATION
{
    ...
    ULONGLONG (*GetReferenceTime)();                                        //0x1c
    ...
    LONG (*MapDeviceLogicalRange)(struct _HAL_HV_DMA_DOMAIN_INFO* arg1, ULONG arg2, ULONGLONG arg3, ULONG* arg4, ULONGLONG* arg5); //0xe0
