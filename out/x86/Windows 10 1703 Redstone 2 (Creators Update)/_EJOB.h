...
struct _EJOB
{
    ...
    struct _EX_PUSH_LOCK IoControlLock;                                     //0x370
    ULONG SiloHardReferenceCount;                                           //0x374
    struct _WORK_QUEUE_ITEM RundownWorkItem;                                //0x378
    VOID* MemoryPartitionObject;                                            //0x388
    union _JOBOBJECT_ENERGY_TRACKING_STATE EnergyTrackingState;             //0x390
};
/* Used in */
// _DEVICE_MAP
// _EJOB
