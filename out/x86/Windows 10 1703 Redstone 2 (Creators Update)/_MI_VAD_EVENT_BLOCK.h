...
#include <_MI_RFG_PROTECTED_STACK.h>
...
struct _MI_VAD_EVENT_BLOCK
{
    ...
    union
    {
        ...
        struct _MI_LARGEPAGE_IMAGE_INFO LargePage;                          //0x4
        struct _ETHREAD* CreatingThread;                                    //0x4
        struct _MI_SUB64K_FREE_RANGES PebTebRfg;                            //0x4
        struct _MI_RFG_PROTECTED_STACK RfgProtectedStack;                   //0x4
    };
