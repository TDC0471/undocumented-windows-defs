...
struct _MI_HARDWARE_STATE
{
    ...
    ULONG FlushTbForAttributeChange;                                        //0x34
    ULONG FlushCacheForAttributeChange;                                     //0x38
    ULONG FlushCacheForPageAttributeChange;                                 //0x3c
    ULONG CacheFlushPromoteThreshold;                                       //0x40
    ULONG FlushTbThreshold;                                                 //0x44
    enum _MI_PFN_CACHE_ATTRIBUTE OptimalZeroingAttribute[4][4];             //0x48
    UCHAR AttributeChangeRequiresReZero;                                    //0x88
