...
struct _EPROCESS
{
    ...
    UCHAR HangCount:4;                                                      //0x2ef
    UCHAR GhostCount:4;                                                     //0x2ef
    union
    {
        ULONG Flags3;                                                       //0x2f0
        struct
        {
            ...
            ULONG SystemProcess:1;                                          //0x2f0
            ULONG HideImageBaseAddresses:1;                                 //0x2f0
        };
    };
    ...
    union
    {
        ULONG MitigationFlags;                                              //0x3d8
        struct
        {
            ULONG ControlFlowGuardEnabled:1;                                //0x3d8
            ULONG ControlFlowGuardExportSuppressionEnabled:1;               //0x3d8
            ULONG ControlFlowGuardStrict:1;                                 //0x3d8
            ULONG DisallowStrippedImages:1;                                 //0x3d8
            ULONG ForceRelocateImages:1;                                    //0x3d8
            ULONG HighEntropyASLREnabled:1;                                 //0x3d8
            ULONG StackRandomizationDisabled:1;                             //0x3d8
            ULONG ExtensionPointDisable:1;                                  //0x3d8
            ULONG DisableDynamicCode:1;                                     //0x3d8
            ULONG DisableDynamicCodeAllowOptOut:1;                          //0x3d8
            ULONG DisableDynamicCodeAllowRemoteDowngrade:1;                 //0x3d8
            ULONG AuditDisableDynamicCode:1;                                //0x3d8
            ULONG DisallowWin32kSystemCalls:1;                              //0x3d8
            ULONG AuditDisallowWin32kSystemCalls:1;                         //0x3d8
            ULONG EnableFilteredWin32kAPIs:1;                               //0x3d8
            ULONG AuditFilteredWin32kAPIs:1;                                //0x3d8
            ULONG DisableNonSystemFonts:1;                                  //0x3d8
            ULONG AuditNonSystemFontLoading:1;                              //0x3d8
            ULONG PreferSystem32Images:1;                                   //0x3d8
            ULONG ProhibitRemoteImageMap:1;                                 //0x3d8
            ULONG AuditProhibitRemoteImageMap:1;                            //0x3d8
            ULONG ProhibitLowILImageMap:1;                                  //0x3d8
            ULONG AuditProhibitLowILImageMap:1;                             //0x3d8
            ULONG SignatureMitigationOptIn:1;                               //0x3d8
            ULONG AuditBlockNonMicrosoftBinaries:1;                         //0x3d8
            ULONG AuditBlockNonMicrosoftBinariesAllowStore:1;               //0x3d8
            ULONG LoaderIntegrityContinuityEnabled:1;                       //0x3d8
            ULONG AuditLoaderIntegrityContinuity:1;                         //0x3d8
            ULONG EnableModuleTamperingProtection:1;                        //0x3d8
            ULONG EnableModuleTamperingProtectionNoInherit:1;               //0x3d8
        } MitigationFlagsValues;                                            //0x3d8
    };
    union
    {
        ULONG MitigationFlags2;                                             //0x3dc
        struct
        {
            ULONG EnableExportAddressFilter:1;                              //0x3dc
            ULONG AuditExportAddressFilter:1;                               //0x3dc
            ULONG EnableExportAddressFilterPlus:1;                          //0x3dc
            ULONG AuditExportAddressFilterPlus:1;                           //0x3dc
            ULONG EnableRopStackPivot:1;                                    //0x3dc
            ULONG AuditRopStackPivot:1;                                     //0x3dc
            ULONG EnableRopCallerCheck:1;                                   //0x3dc
            ULONG AuditRopCallerCheck:1;                                    //0x3dc
            ULONG EnableRopSimExec:1;                                       //0x3dc
            ULONG AuditRopSimExec:1;                                        //0x3dc
            ULONG EnableImportAddressFilter:1;                              //0x3dc
            ULONG AuditImportAddressFilter:1;                               //0x3dc
        } MitigationFlags2Values;                                           //0x3dc
    };
    VOID* PartitionObject;                                                  //0x3e0
};
/* Used in */
