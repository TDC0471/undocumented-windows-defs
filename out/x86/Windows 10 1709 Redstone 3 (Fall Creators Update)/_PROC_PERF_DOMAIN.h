...
struct _PROC_PERF_DOMAIN
{
    ...
    struct _PROC_PERF_QOS_CLASS_POLICY QosPolicies[3];                      //0x8c
    ULONG QosDisableReasons[3];                                             //0xd4
    ULONG QosEquivalencyMasks[3];                                           //0xe0
    UCHAR QosSupported;                                                     //0xec
    ULONG SelectionGeneration;                                              //0xf0
    struct _PERF_CONTROL_STATE_SELECTION QosSelection[3];                   //0xf8
    ULONGLONG PerfChangeTime;                                               //0x170
    ULONG PerfChangeIntervalCount;                                          //0x178
    UCHAR Force;                                                            //0x17c
};
/* Used in */
