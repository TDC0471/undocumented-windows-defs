...
struct _HEAP
{
    ...
    UCHAR RequestedFrontEndHeapType;                                        //0xdb
    USHORT* FrontEndHeapUsageData;                                          //0xdc
    USHORT FrontEndHeapMaximumIndex;                                        //0xe0
    volatile UCHAR FrontEndHeapStatusBitmap[257];                           //0xe2
    struct _HEAP_COUNTERS Counters;                                         //0x1e4
    struct _HEAP_TUNING_PARAMETERS TuningParameters;                        //0x240
};
/* Used in */
// _HEAP
// _HEAP_SEGMENT
