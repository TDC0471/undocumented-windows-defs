...
struct _PROCESSOR_POWER_STATE
{
    ...
    UCHAR GuaranteedPerformancePercent;                                     //0x14c
    UCHAR HvTargetState;                                                    //0x14d
    UCHAR Parked;                                                           //0x14e
    UCHAR LongPriorQosPeriod;                                               //0x14f
    ULONG LatestPerformancePercent;                                         //0x150
    ULONG AveragePerformancePercent;                                        //0x154
    ULONG LatestAffinitizedPercent;                                         //0x158
    ...
    ULONG QosEquivalencyMask;                                               //0x1a0
};
/* Used in */
// _KPRCB
