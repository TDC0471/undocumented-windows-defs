...
struct _PRIVATE_CACHE_MAP
{
    ...
    ULONG ReadAheadSpinLock;                                                //0x50
    ULONG PipelinedReadAheadRequestSize;                                    //0x54
    ULONG ReadAheadGrowth;                                                  //0x58
    struct _LIST_ENTRY PrivateLinks;                                        //0x5c
    VOID* ReadAheadWorkItem;                                                //0x64
};
/* Used in */
// _SHARED_CACHE_MAP
