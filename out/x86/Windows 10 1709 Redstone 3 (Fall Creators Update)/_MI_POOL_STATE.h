...
struct _MI_POOL_STATE
{
    ...
    ULONG SpecialPoolRejected[6];                                           //0x4b0
    volatile ULONG SpecialPagesNonPaged;                                    //0x4c8
    volatile LONG SpecialPoolPdes;                                          //0x4cc
    ULONG SessionSpecialPoolPdesMax;                                        //0x4d0
    ULONG TotalPagedPoolQuota;                                              //0x4d4
    ULONG TotalNonPagedPoolQuota;                                           //0x4d8
};
/* Used in */
