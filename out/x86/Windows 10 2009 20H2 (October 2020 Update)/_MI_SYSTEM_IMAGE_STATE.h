...
struct _MI_SYSTEM_IMAGE_STATE
{
    ...
    struct _KLDR_DATA_TABLE_ENTRY* SystemBase[2];                           //0x30
    struct _KLDR_DATA_TABLE_ENTRY* BeingDeleted;                            //0x38
    struct _EX_PUSH_LOCK MappingRangesPushLock;                             //0x3c
    struct _MI_DRIVER_VA* MappingRanges[2];                                 //0x40
    ULONG PageCount;                                                        //0x48
    struct _MM_SYSTEM_PAGE_COUNTS PageCounts;                               //0x4c
    struct _EX_PUSH_LOCK CollidedLock;                                      //0x5c
    struct _RTL_AVL_TREE ImageTree;                                         //0x60
};
/* Used in */
