...
struct _TOKEN
{
    ...
    struct _SECURITY_TOKEN_PROXY_DATA* ProxyData;                           //0xbc
    struct _SECURITY_TOKEN_AUDIT_DATA* AuditData;                           //0xc0
    struct _SEP_LOGON_SESSION_REFERENCES* LogonSession;                     //0xc4
    struct _LUID OriginatingLogonSession;                                   //0xc8
    struct _SID_AND_ATTRIBUTES_HASH SidHash;                                //0xd0
    struct _SID_AND_ATTRIBUTES_HASH RestrictedSidHash;                      //0x158
    ULONG VariablePart;                                                     //0x1e0
};
