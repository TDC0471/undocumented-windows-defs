...
{
    ULONG RefCount;                                                         //0x0
    ULONG ExtFlags:9;                                                       //0x4
    ULONG PrivateAlloc:1;                                                   //0x4
    ULONG Delete:1;                                                         //0x4
    ULONG DelayedCloseIndex:11;                                             //0x4
    ...
    ULONG Flags:16;                                                         //0x60
    struct _LIST_ENTRY KCBUoWListHead;                                      //0x64
    struct _CM_TRANS* TransKCBOwner;                                        //0x6c
    struct _CM_INTENT_LOCK KCBLock;                                         //0x70
    struct _CM_INTENT_LOCK KeyLock;                                         //0x78
    struct _CHILD_LIST TransValueCache;                                     //0x80
    struct _CM_TRANS* TransValueListOwner;                                  //0x88
    struct _UNICODE_STRING* FullKCBName;                                    //0x8c
};
/* Used in */
// _CACHED_CHILD_LIST
// _CMHIVE
