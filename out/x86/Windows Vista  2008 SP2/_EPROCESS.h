...
struct _EPROCESS
{
    ...
    union
    {
        ...
        struct
        {
            ...
            ULONG AffinityPermanent:1;                                      //0x224
            ULONG AffinityUpdateEnable:1;                                   //0x224
            ULONG CrossSessionCreate:1;                                     //0x224
        };
    };
    union
    {
        ...
        struct
        {
            ...
            ULONG ProcessSelfDelete:1;                                      //0x228
            ULONG SpareProcessFlags:1;                                      //0x228
        };
    };
