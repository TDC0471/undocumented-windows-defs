...
struct _TOKEN
{
    ...
    UCHAR TokenFlags;                                                       //0x88
    UCHAR TokenInUse;                                                       //0x89
    struct _SECURITY_TOKEN_PROXY_DATA* ProxyData;                           //0x8c
    struct _SECURITY_TOKEN_AUDIT_DATA* AuditData;                           //0x90
    struct _SEP_LOGON_SESSION_REFERENCES* LogonSession;                     //0x94
