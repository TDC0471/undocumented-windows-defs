...
struct _POP_POWER_ACTION
{
    ...
    struct _POP_DEVICE_SYS_STATE* DevState;                                 //0x24
    struct _POP_HIBER_CONTEXT* HiberContext;                                //0x28
    enum _SYSTEM_POWER_STATE LastWakeState;                                 //0x2c
    ULONGLONG WakeTime;                                                     //0x30
    ULONGLONG SleepTime;                                                    //0x38
};
