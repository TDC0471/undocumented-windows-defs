...
struct _ETW_FILTER_HEADER
{
    ...
    struct _ETW_FILTER_STRING_TOKEN* ContainerFilter;                       //0x14
    struct _ETW_PERFECT_HASH_FUNCTION* StackWalkIdFilter;                   //0x18
    struct _ETW_FILTER_EVENT_NAME_DATA* StackWalkNameFilter;                //0x1c
    struct _EVENT_FILTER_LEVEL_KW* StackWalkLevelKwFilter;                  //0x20
    struct _ETW_PERFECT_HASH_FUNCTION* EventIdFilter;                       //0x24
    struct _ETW_PAYLOAD_FILTER* PayloadFilter;                              //0x28
    struct _EVENT_FILTER_HEADER* ProviderSideFilter;                        //0x2c
    struct _ETW_FILTER_EVENT_NAME_DATA* EventNameFilter;                    //0x30
};
/* Used in */
// _ETW_GUID_ENTRY
