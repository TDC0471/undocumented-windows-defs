...
struct _MI_PARTITION_MODWRITES
{
    ...
    volatile LONG ClusterRestrictionLock;                                   //0x16c
    struct _MI_RESTRICTED_MODWRITES ClusterRestrictions[2];                 //0x170
    struct _KEVENT NotifyStoreMemoryConditions;                             //0x178
    volatile UCHAR DelayMappedWrite;                                        //0x188
    volatile ULONG PagefileReservationsEnabled;                             //0x18c
    struct _EX_PUSH_LOCK PageFileCreationLock;                              //0x190
    struct _WORK_QUEUE_ITEM TrimPagefileWorkItem;                           //0x194
