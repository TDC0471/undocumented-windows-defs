...
#include <_HIDDEN_PROCESSOR_POWER_INTERFACE.h>
...
struct HAL_PRIVATE_DISPATCH
{
    ...
    ULONGLONG (*HalTimerWatchdogQueryDueTime)(UCHAR arg1);                  //0x1ec
    ...
    LONG (*HalGetHiddenProcessorPowerInterface)(struct _HIDDEN_PROCESSOR_POWER_INTERFACE* arg1); //0x23c
    ...
    VOID (*HalIommuReportIommuFault)(ULONGLONG arg1, struct _FAULT_INFORMATION* arg2); //0x250
    UCHAR (*HalIommuDmaRemappingCapable)(struct _EXT_IOMMU_DEVICE_ID* arg1, ULONG* arg2); //0x254
};
