...
struct _WMI_LOGGER_CONTEXT
{
    ...
    LONGLONG ReferenceQpcDelta;                                             //0x370
    struct _ETW_EVENT_CALLBACK_CONTEXT* CallbackContext;                    //0x378
    union _LARGE_INTEGER* LastDroppedTime;                                  //0x37c
    union _LARGE_INTEGER* FlushingLastDroppedTime;                          //0x380
    LONGLONG FlushingSequenceNumber;                                        //0x388
    struct _ETW_PARTITION_CONTEXT PartitionContext;                         //0x390
    struct _MDL* BufferMdl;                                                 //0x394
};
/* Used in */
