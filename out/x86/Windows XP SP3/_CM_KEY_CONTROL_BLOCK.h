...
struct _CM_KEY_CONTROL_BLOCK
{
    ...
    union _LARGE_INTEGER KcbLastWriteTime;                                  //0x38
    USHORT KcbMaxNameLen;                                                   //0x40
    USHORT KcbMaxValueNameLen;                                              //0x42
    ULONG KcbMaxValueDataLen;                                               //0x44
    ULONG KcbUserFlags:4;                                                   //0x48
    ULONG KcbVirtControlFlags:4;                                            //0x48
    ULONG KcbDebug:8;                                                       //0x48
    ULONG Flags:16;                                                         //0x48
};
/* Used in */
// _CACHED_CHILD_LIST
