...
struct _EJOB
{
    ...
    struct _EJOB* ParentSilo;                                               //0x240
    struct _EJOB* volatile RootJob;                                         //0x244
    struct _LIST_ENTRY IteratorListHead;                                    //0x248
    ULONG AncestorCount;                                                    //0x250
    union
    {
        struct _EJOB** Ancestors;                                           //0x254
        VOID* SessionObject;                                                //0x254
    };
    ULONG TimerListLock;                                                    //0x258
    struct _LIST_ENTRY TimerListHead;                                       //0x25c
    struct _EPROCESS_VALUES Accounting;                                     //0x268
    ULONG ShadowActiveProcessCount;                                         //0x2c0
    ULONG ActiveAuxiliaryProcessCount;                                      //0x2c4
    ULONG SequenceNumber;                                                   //0x2c8
    ULONG JobId;                                                            //0x2cc
    struct _GUID ContainerId;                                               //0x2d0
    struct _ESERVERSILO_GLOBALS* ServerSiloGlobals;                         //0x2e0
    struct _PS_PROPERTY_SET PropertySet;                                    //0x2e4
    struct _PSP_STORAGE* Storage;                                           //0x2f0
    struct _JOB_NET_RATE_CONTROL* NetRateControl;                           //0x2f4
    union
    {
        ULONG JobFlags;                                                     //0x2f8
        struct
        {
            ULONG CloseDone:1;                                              //0x2f8
            ULONG MultiGroup:1;                                             //0x2f8
            ULONG OutstandingNotification:1;                                //0x2f8
            ULONG NotificationInProgress:1;                                 //0x2f8
            ULONG UILimits:1;                                               //0x2f8
            ULONG CpuRateControlActive:1;                                   //0x2f8
            ULONG OwnCpuRateControl:1;                                      //0x2f8
            ULONG Terminating:1;                                            //0x2f8
            ULONG WorkingSetLock:1;                                         //0x2f8
            ULONG JobFrozen:1;                                              //0x2f8
            ULONG Background:1;                                             //0x2f8
            ULONG WakeNotificationAllocated:1;                              //0x2f8
            ULONG WakeNotificationEnabled:1;                                //0x2f8
            ULONG WakeNotificationPending:1;                                //0x2f8
            ULONG LimitNotificationRequired:1;                              //0x2f8
            ULONG ZeroCountNotificationRequired:1;                          //0x2f8
            ULONG CycleTimeNotificationRequired:1;                          //0x2f8
            ULONG CycleTimeNotificationPending:1;                           //0x2f8
            ULONG TimersVirtualized:1;                                      //0x2f8
            ULONG JobSwapped:1;                                             //0x2f8
            ULONG ViolationDetected:1;                                      //0x2f8
            ULONG EmptyJobNotified:1;                                       //0x2f8
            ULONG NoSystemCharge:1;                                         //0x2f8
            ULONG DropNoWakeCharges:1;                                      //0x2f8
            ULONG NoWakeChargePolicyDecided:1;                              //0x2f8
            ULONG NetRateControlActive:1;                                   //0x2f8
            ULONG OwnNetRateControl:1;                                      //0x2f8
            ULONG IoRateControlActive:1;                                    //0x2f8
            ULONG OwnIoRateControl:1;                                       //0x2f8
            ULONG DisallowNewProcesses:1;                                   //0x2f8
            ULONG Silo:1;                                                   //0x2f8
            ULONG Spare:1;                                                  //0x2f8
        };
    };
    ULONG EffectiveHighEdgeFilters;                                         //0x2fc
    struct _PROCESS_ENERGY_VALUES* EnergyValues;                            //0x300
    volatile ULONG SharedCommitCharge;                                      //0x304
    struct _EJOB* volatile WakeRoot;                                        //0x308
    ULONG DiskIoAttributionUserRefCount;                                    //0x30c
    ULONG DiskIoAttributionRefCount;                                        //0x310
    union
    {
        VOID* DiskIoAttributionContext;                                     //0x314
        struct _EJOB* DiskIoAttributionOwnerJob;                            //0x314
    };
    struct _PS_IO_CONTROL_ENTRY GlobalIoControl;                            //0x318
    volatile LONG VolumeIoControlLock;                                      //0x334
    struct _RTL_RB_TREE VolumeIoControlTree;                                //0x338
    struct _EX_PUSH_LOCK IoControlLock;                                     //0x340
    ULONG SiloHardReferenceCount;                                           //0x344
    struct _WORK_QUEUE_ITEM RundownWorkItem;                                //0x348
};
/* Used in */
// _DEVICE_MAP
// _EJOB
