...
struct _EPROCESS
{
    ...
    volatile ULONG CommitCharge;                                            //0x1e8
    struct _MMSUPPORT Vm;                                                   //0x1ec
    ...
    ULONGLONG DeepFreezeStartTime;                                          //0x2f8
    ULONG CommitChargeLimit;                                                //0x300
    volatile ULONG CommitChargePeak;                                        //0x304
    ULONG HighPriorityFaultsAllowed;                                        //0x308
};
/* Used in */
