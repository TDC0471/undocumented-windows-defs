...
struct _EJOB
{
    ...
    struct _JOBOBJECT_WAKE_FILTER WakeFilter;                               //0x1e0
    ULONG LowEdgeLatchFilter;                                               //0x1e8
    ULONG OwnedHighEdgeFilters;                                             //0x1ec
    struct _EJOB* NotificationLink;                                         //0x1f0
    ULONGLONG CurrentJobMemoryUsed;                                         //0x1f8
    struct _JOB_NOTIFICATION_INFORMATION* NotificationInfo;                 //0x200
    VOID* NotificationInfoQuotaReference;                                   //0x204
    struct _IO_MINI_COMPLETION_PACKET_USER* NotificationPacket;             //0x208
    struct _JOB_CPU_RATE_CONTROL* CpuRateControl;                           //0x20c
    VOID* EffectiveSchedulingGroup;                                         //0x210
    ULONGLONG ReadyTime;                                                    //0x218
    struct _EX_PUSH_LOCK MemoryLimitsLock;                                  //0x220
    struct _LIST_ENTRY SiblingJobLinks;                                     //0x224
    struct _LIST_ENTRY ChildJobListHead;                                    //0x22c
    struct _EJOB* ParentJob;                                                //0x234
    struct _EJOB* volatile RootJob;                                         //0x238
    struct _LIST_ENTRY IteratorListHead;                                    //0x23c
    ULONG AncestorCount;                                                    //0x244
    struct _EJOB** Ancestors;                                               //0x248
    struct _EPROCESS_VALUES Accounting;                                     //0x250
    ULONG ShadowActiveProcessCount;                                         //0x2a0
    ULONG SequenceNumber;                                                   //0x2a4
    ULONG TimerListLock;                                                    //0x2a8
    struct _LIST_ENTRY TimerListHead;                                       //0x2ac
    union
    {
        ULONG JobFlags;                                                     //0x2b4
        struct
        {
            ULONG CloseDone:1;                                              //0x2b4
            ULONG MultiGroup:1;                                             //0x2b4
            ULONG OutstandingNotification:1;                                //0x2b4
            ULONG NotificationInProgress:1;                                 //0x2b4
            ULONG UILimits:1;                                               //0x2b4
            ULONG CpuRateControlActive:1;                                   //0x2b4
            ULONG OwnCpuRateControl:1;                                      //0x2b4
            ULONG Terminating:1;                                            //0x2b4
            ULONG WorkingSetLock:1;                                         //0x2b4
            ULONG JobFrozen:1;                                              //0x2b4
            ULONG Background:1;                                             //0x2b4
            ULONG WakeNotificationAllocated:1;                              //0x2b4
            ULONG WakeNotificationEnabled:1;                                //0x2b4
            ULONG WakeNotificationPending:1;                                //0x2b4
            ULONG LimitNotificationRequired:1;                              //0x2b4
            ULONG ZeroCountNotificationRequired:1;                          //0x2b4
            ULONG CycleTimeNotificationRequired:1;                          //0x2b4
            ULONG CycleTimeNotificationPending:1;                           //0x2b4
            ULONG TimersVirtualized:1;                                      //0x2b4
            ULONG JobSwapped:1;                                             //0x2b4
            ULONG ViolationDetected:1;                                      //0x2b4
            ULONG EmptyJobNotified:1;                                       //0x2b4
            ULONG NoSystemCharge:1;                                         //0x2b4
            ULONG DropNoWakeCharges:1;                                      //0x2b4
            ULONG NoWakeChargePolicyDecided:1;                              //0x2b4
            ULONG SpareJobFlags:7;                                          //0x2b4
        };
    };
    ULONG EffectiveHighEdgeFilters;                                         //0x2b8
};
/* Used in */
// _EJOB
// _EPROCESS
