...
struct _CONTROL_AREA
{
    ...
    struct _EX_PUSH_LOCK FileObjectLock;                                    //0x3c
    volatile ULONGLONG LockedPages;                                         //0x40
    union
    {
        ULONG IoAttributionContext:29;                                      //0x48
        ULONG Spare:3;                                                      //0x48
        ULONG ImageCrossPartitionCharge;                                    //0x48
        ULONG CommittedPageCount:20;                                        //0x48
    } u3;                                                                   //0x48
};
/* Used in */
