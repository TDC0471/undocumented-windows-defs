...
struct _ETHREAD
{
    ...
    union
    {
        ...
        struct
        {
            ...
            ULONG SamplingCoverage:1;                                       //0x3cc
            ULONG ReservedCrossThreadFlags:8;                               //0x3cc
        };
    };
    union
    {
        ...
        struct
        {
            ...
            ULONG WorkloadClass:1;                                          //0x3d0
            ULONG ReservedSameThreadPassiveFlags:20;                        //0x3d0
        };
    };
    union
    {
    ...
    ULONG KernelStackReference;                                             //0x400
    struct _LIST_ENTRY BoostList;                                           //0x404
    struct _LIST_ENTRY DeboostList;                                         //0x40c
    ULONG BoostListLock;                                                    //0x414
    ULONG IrpListLock;                                                      //0x418
    VOID* ReservedForSynchTracking;                                         //0x41c
    struct _SINGLE_LIST_ENTRY CmCallbackListHead;                           //0x420
    struct _GUID* ActivityId;                                               //0x424
    struct _SINGLE_LIST_ENTRY SeLearningModeListHead;                       //0x428
    VOID* VerifierContext;                                                  //0x42c
    ...
    ULONG HeapData;                                                         //0x468
    struct _LIST_ENTRY OwnerEntryListHead;                                  //0x46c
    ULONG DisownedOwnerEntryListLock;                                       //0x474
    struct _LIST_ENTRY DisownedOwnerEntryListHead;                          //0x478
};
/* Used in */
