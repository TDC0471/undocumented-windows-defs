...
struct _MI_PARTITION_SEGMENTS
{
    ...
    VOID* SegmentDereferenceActiveControlArea;                              //0xdc
    ULONG UnusedSegmentPagedPool;                                           //0xe0
    struct _LIST_ENTRY UnusedSegmentList;                                   //0xe4
    struct _LIST_ENTRY UnusedSubsectionList;                                //0xec
    struct _LIST_ENTRY DeleteSubsectionList;                                //0xf4
    struct _KEVENT ControlAreaDeleteEvent;                                  //0xfc
    struct _SINGLE_LIST_ENTRY ControlAreaDeleteList;                        //0x10c
