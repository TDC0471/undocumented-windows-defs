...
struct _PROC_PERF_DOMAIN
{
    ...
    struct _PROC_PERF_QOS_CLASS_POLICY QosPolicies[4];                      //0x90
    ULONG QosDisableReasons[4];                                             //0x100
    USHORT QosEquivalencyMasks[4];                                          //0x110
    UCHAR QosSupported;                                                     //0x118
    volatile ULONG SelectionGeneration;                                     //0x11c
    struct _PERF_CONTROL_STATE_SELECTION QosSelection[4];                   //0x120
    ULONGLONG PerfChangeTime;                                               //0x1c0
    ULONG PerfChangeIntervalCount;                                          //0x1c8
    UCHAR Force;                                                            //0x1cc
};
/* Used in */
