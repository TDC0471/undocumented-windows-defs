...
struct _EPROCESS
{
    ...
    UCHAR HangCount:3;                                                      //0x2f7
    UCHAR GhostCount:3;                                                     //0x2f7
    UCHAR PrefilterException:1;                                             //0x2f7
    union
    {
        ULONG Flags3;                                                       //0x2f8
        struct
        {
            ...
            ULONG EnableProcessSuspendResumeLogging:1;                      //0x2f8
            ULONG EnableThreadSuspendResumeLogging:1;                       //0x2f8
            ULONG SecurityDomainChanged:1;                                  //0x2f8
            ULONG SecurityFreezeComplete:1;                                 //0x2f8
            ULONG VmProcessorHost:1;                                        //0x2f8
        };
    };
    ...
    union
    {
        ...
        struct
        {
            ...
            ULONG RestrictIndirectBranchPrediction:1;                       //0x3e0
            ULONG IsolateSecurityDomain:1;                                  //0x3e0
    ...
    union
    {
        ...
        struct
        {
            ...
            ULONG DisablePageCombine:1;                                     //0x3e4
            ULONG SpeculativeStoreBypassDisable:1;                          //0x3e4
            ULONG CetShadowStacks:1;                                        //0x3e4
        } MitigationFlags2Values;                                           //0x3e4
    };
    VOID* PartitionObject;                                                  //0x3e8
    ULONGLONG SecurityDomain;                                               //0x3f0
    ULONGLONG ParentSecurityDomain;                                         //0x3f8
    VOID* CoverageSamplerContext;                                           //0x400
    VOID* MmHotPatchContext;                                                //0x404
};
/* Used in */
