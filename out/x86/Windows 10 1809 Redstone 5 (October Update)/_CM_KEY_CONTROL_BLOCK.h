...
struct _CM_KEY_CONTROL_BLOCK
{
    ...
    struct _CACHED_CHILD_LIST ValueCache;                                   //0x30
    union
    {
        struct _CM_INDEX_HINT_BLOCK* IndexHint;                             //0x38
        ULONG HashKey;                                                      //0x38
        ULONG SubKeyCount;                                                  //0x38
    };
    union
    {
        struct _LIST_ENTRY KeyBodyListHead;                                 //0x3c
        struct _LIST_ENTRY FreeListEntry;                                   //0x3c
    };
    struct _CM_KEY_BODY* KeyBodyArray[4];                                   //0x44
