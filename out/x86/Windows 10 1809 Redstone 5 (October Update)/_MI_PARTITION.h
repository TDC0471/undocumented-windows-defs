...
struct _MI_PARTITION
{
    ...
    struct _MI_PARTITION_COMMIT Commit;                                     //0xe80
    struct _MI_PARTITION_ZEROING Zeroing;                                   //0xf00
    struct _MI_PAGE_COMBINING_SUPPORT PageCombine;                          //0xf40
    VOID* WorkingSetControl;                                                //0x1018
    struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;           //0x101c
    struct _MI_VISIBLE_PARTITION Vp;                                        //0x1040
};
/* Used in */
