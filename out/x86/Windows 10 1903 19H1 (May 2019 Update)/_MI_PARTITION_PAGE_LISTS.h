...
struct _MI_PARTITION_PAGE_LISTS
{
    ...
    UCHAR RebuildLargePageCandidates;                                       //0x868
    UCHAR RebuildLargePageActive;                                           //0x869
    volatile LONG LargePageRebuildLock;                                     //0x86c
    ULONG LowMemoryThreshold;                                               //0x870
    ULONG HighMemoryThreshold;                                              //0x874
    struct _MI_SLAB_ALLOCATOR_CONTEXT SlabContexts[2][4];                   //0x878
    struct _RTL_BITMAP SlabPfnBitMap;                                       //0xab8
};
/* Used in */
// _MI_PARTITION
