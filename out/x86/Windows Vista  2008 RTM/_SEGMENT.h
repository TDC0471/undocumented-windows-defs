...
struct _SEGMENT
{
    ...
    struct _SEGMENT_FLAGS SegmentFlags;                                     //0x20
    union
    {
        ULONG ImageCommitment;                                              //0x24
        struct _EPROCESS* CreatingProcess;                                  //0x24
    } u1;                                                                   //0x24
    union
    {
        struct _MI_SECTION_IMAGE_INFORMATION* ImageInformation;             //0x28
        VOID* FirstMappedVa;                                                //0x28
    } u2;                                                                   //0x28
    struct _MMPTE* PrototypePte;                                            //0x2c
    struct _MMPTE ThePtes[1];                                               //0x30
};
/* Used in */
// _CONTROL_AREA
