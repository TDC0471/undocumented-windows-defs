...
struct _ARBITER_INSTANCE
{
    ...
    VOID* Extension;                                                        //0x94
    struct _DEVICE_OBJECT* BusDeviceObject;                                 //0x98
    VOID* ConflictCallbackContext;                                          //0x9c
    UCHAR (*ConflictCallback)(VOID* arg1, struct _RTL_RANGE* arg2);         //0xa0
    WCHAR PdoDescriptionString[336];                                        //0xa4
    CHAR PdoSymbolicNameString[672];                                        //0x344
    WCHAR PdoAddressString[1];                                              //0x5e4
};
/* Used in */
// _ARBITER_INSTANCE
