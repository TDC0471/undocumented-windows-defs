...
struct _MM_DRIVER_VERIFIER_DATA
{
    ...
    volatile ULONGLONG PeakPagedBytes;                                      //0x60
    volatile ULONGLONG PeakNonPagedBytes;                                   //0x68
    volatile ULONG BurstAllocationsFailedDeliberately;                      //0x70
    volatile ULONG SessionTrims;                                            //0x74
    volatile ULONG OptionChanges;                                           //0x78
    volatile ULONG VerifyMode;                                              //0x7c
    struct _UNICODE_STRING PreviousBucketName;                              //0x80
    volatile ULONG ActivityCounter;                                         //0x90
    volatile ULONG PreviousActivityCounter;                                 //0x94
    volatile ULONG WorkerTrimRequests;                                      //0x98
};
