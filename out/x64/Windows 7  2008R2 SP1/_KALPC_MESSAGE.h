...
struct _KALPC_MESSAGE
{
    ...
    union
    {
        struct
        {
            ...
            ULONG ViewAttributeRetrieved:1;                                 //0x2c
            ULONG InDispatch:1;                                             //0x2c
        } s1;                                                               //0x2c
        ULONG State;                                                        //0x2c
    } u1;                                                                   //0x2c
    ...
    struct _KALPC_MESSAGE_ATTRIBUTES MessageAttributes;                     //0x78
    VOID* DataUserVa;                                                       //0xb0
    VOID* DataSystemVa;                                                     //0xb8
    struct _ALPC_COMMUNICATION_INFO* CommunicationInfo;                     //0xc0
    struct _ALPC_PORT* ConnectionPort;                                      //0xc8
    struct _ETHREAD* ServerThread;                                          //0xd0
