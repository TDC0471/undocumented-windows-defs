...
#include <_PNP_PROBLEM_CODE_LOG_ENTRY.h>
...
struct _DEVICE_NODE
{
    ...
    struct _PNP_PROBLEM_CODE_LOG_ENTRY ProblemCodeLog[4];                   //0x310
    ULONG ProblemCodeLogNextIndex;                                          //0x370
    union _LARGE_INTEGER StateTimestamp;                                    //0x378
    union _LARGE_INTEGER PreviousStateTimestamp;                            //0x380
};
/* Used in */
// _DEVICE_NODE
