...
#include <_INVERTED_FUNCTION_TABLE_KERNEL_MODE.h>
...
#include <_KE_IDEAL_PROCESSOR_ASSIGNMENT_BLOCK.h>
#include <_PS_DYNAMIC_ENFORCED_ADDRESS_RANGES.h>
#include <_PS_SYSCALL_PROVIDER.h>
#include <_PSP_SYSCALL_PROVIDER_DISPATCH_CONTEXT.h>
...
struct _EPROCESS
{
    ...
    union
    {
        ...
        struct
        {
            ...
            ULONG DisallowFsctlSystemCalls:1;                               //0xb70
            ULONG AuditDisallowFsctlSystemCalls:1;                          //0xb70
            ULONG MitigationFlags3Spare:29;                                 //0xb70
