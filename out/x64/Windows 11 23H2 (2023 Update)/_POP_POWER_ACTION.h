...
struct _POP_POWER_ACTION
{
    ...
    ULONG WatchdogTimeout;                                                  //0x1b0
    struct _KTHREAD* ActionWorkerThread;                                    //0x1b8
    struct _KTHREAD* PromoteActionWorkerThread;                             //0x1c0
    struct _KTHREAD* UnlockAfterSleepWorkerThread;                          //0x1c8
};
