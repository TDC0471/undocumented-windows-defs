...
struct _KALPC_MESSAGE
{
    ...
    VOID* DataSystemVa;                                                     //0xa8
    struct _ALPC_COMMUNICATION_INFO* CommunicationInfo;                     //0xb0
    struct _ALPC_PORT* ConnectionPort;                                      //0xb8
    struct _ETHREAD* ServerThread;                                          //0xc0
    VOID* WakeReference;                                                    //0xc8
    VOID* ExtensionBuffer;                                                  //0xd0
    ULONGLONG ExtensionBufferSize;                                          //0xd8
