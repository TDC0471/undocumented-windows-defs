...
struct _DEVICE_NODE
{
    ...
    ULONG Level;                                                            //0x50
    union _POWER_STATE CurrentPowerState;                                   //0x54
    struct _PO_DEVICE_NOTIFY Notify;                                        //0x58
    struct _PO_IRP_MANAGER PoIrpManager;                                    //0xc0
    struct _POP_FX_DEVICE* FxDevice;                                        //0xe0
    volatile LONG FxDeviceLock;                                             //0xe8
    struct _KEVENT FxRemoveEvent;                                           //0xf0
    volatile LONG FxActivationCount;                                        //0x108
    volatile LONG FxSleepCount;                                             //0x10c
    struct _POP_FX_PLUGIN* Plugin;                                          //0x110
    struct _UNICODE_STRING UniqueId;                                        //0x118
    ULONG PowerFlags;                                                       //0x128
