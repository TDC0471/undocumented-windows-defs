...
struct _KTHREAD
{
    ...
    struct _KQUEUE* volatile Queue;                                         //0xe8
    VOID* Teb;                                                              //0xf0
    ...
    volatile ULONG DeferredProcessor;                                       //0x21c
    struct _KPROCESS* Process;                                              //0x220
    union
    {
        volatile struct _GROUP_AFFINITY UserAffinity;                       //0x228
        struct
        {
    ...
    union
    {
        volatile struct _GROUP_AFFINITY Affinity;                           //0x238
        struct
        {
    ...
    LONGLONG ReadOperationCount;                                            //0x318
    LONGLONG WriteOperationCount;                                           //0x320
    LONGLONG OtherOperationCount;                                           //0x328
    LONGLONG ReadTransferCount;                                             //0x330
    LONGLONG WriteTransferCount;                                            //0x338
    LONGLONG OtherTransferCount;                                            //0x340
};
/* Used in */
// _CMHIVE
