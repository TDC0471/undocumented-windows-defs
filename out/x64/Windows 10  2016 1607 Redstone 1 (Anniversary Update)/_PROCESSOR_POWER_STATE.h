...
struct _PROCESSOR_POWER_STATE
{
    ...
    struct _PROC_PERF_LOAD* Load;                                           //0x188
    struct _PROC_PERF_HISTORY* PerfHistory;                                 //0x190
    UCHAR GuaranteedPerformancePercent;                                     //0x198
    UCHAR HvTargetState;                                                    //0x199
    UCHAR Parked;                                                           //0x19a
    ULONG LatestPerformancePercent;                                         //0x19c
    ULONG AveragePerformancePercent;                                        //0x1a0
    ULONG LatestAffinitizedPercent;                                         //0x1a4
    ULONG RelativePerformance;                                              //0x1a8
    ULONG Utility;                                                          //0x1ac
    ULONG AffinitizedUtility;                                               //0x1b0
    union
    {
        ULONGLONG SnapTimeLast;                                             //0x1b8
        ULONGLONG EnergyConsumed;                                           //0x1b8
    };
    ULONGLONG ActiveTime;                                                   //0x1c0
    ULONGLONG TotalTime;                                                    //0x1c8
};
/* Used in */
// _KPRCB
