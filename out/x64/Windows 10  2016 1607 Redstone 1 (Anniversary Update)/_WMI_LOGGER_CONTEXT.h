...
struct _WMI_LOGGER_CONTEXT
{
    ...
    struct _ETW_SOFT_RESTART_CONTEXT* SoftRestartContext;                   //0x380
    struct _ETW_SILODRIVERSTATE* SiloState;                                 //0x388
    struct _WORK_QUEUE_ITEM CompressionWorkItem;                            //0x390
    LONG CompressionWorkItemState;                                          //0x3b0
    struct _EX_PUSH_LOCK CompressionLock;                                   //0x3b8
    struct _WMI_BUFFER_HEADER* CompressionTarget;                           //0x3c0
    VOID* CompressionWorkspace;                                             //0x3c8
    LONG CompressionOn;                                                     //0x3d0
    ULONG CompressionRatioGuess;                                            //0x3d4
    ULONG PartialBufferCompressionLevel;                                    //0x3d8
    enum ETW_COMPRESSION_RESUMPTION_MODE CompressionResumptionMode;         //0x3dc
    struct _SINGLE_LIST_ENTRY PlaceholderList;                              //0x3e0
    struct _KDPC CompressionDpc;                                            //0x3e8
    union _LARGE_INTEGER LastBufferSwitchTime;                              //0x428
    union _LARGE_INTEGER BufferWriteDuration;                               //0x430
    union _LARGE_INTEGER BufferCompressDuration;                            //0x438
};
/* Used in */
