...
struct _HAL_IOMMU_DISPATCH
{
    ...
    LONG (*HalIommuCreateAtsDevice)(struct _EXT_IOMMU_DEVICE_ID* arg1, union _IOMMU_SVM_CAPABILITIES* arg2, VOID** arg3); //0xa0
    LONG (*HalIommuConfigureAts)(VOID* arg1, UCHAR arg2);                   //0xa8
    VOID (*HalIommuDeleteAtsDevice)(VOID* arg1);                            //0xb0
};
/* Used in */
