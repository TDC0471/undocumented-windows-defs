...
struct _HAL_INTEL_ENLIGHTENMENT_INFORMATION
{
    ...
    LONG (*AllocateDeviceDomain)(struct _HAL_HV_DMA_CREATE_DOMAIN_INFO* arg1); //0x190
    ...
    LONG (*UpdateMicrocode)(VOID* arg1, ULONG arg2, UCHAR arg3);            //0x1d8
    LONG (*GetSintMessage)(UCHAR arg1, VOID** arg2);                        //0x1e0
    LONG (*SetRootFaultReportingReady)();                                   //0x1e8
    LONG (*ConfigureDeviceDomain)(struct _HAL_HV_DMA_DOMAIN_INFO* arg1, struct _HAL_HV_DMA_DOMAIN_CONFIG* arg2); //0x1f0
    LONG (*UnblockDefaultDma)();                                            //0x1f8
    LONG (*FlushDeviceDomain)(struct _HAL_HV_DMA_DOMAIN_INFO* arg1);        //0x200
    LONG (*FlushDeviceDomainVaList)(struct _HAL_HV_DMA_DOMAIN_INFO* arg1, ULONG arg2, struct _KTB_FLUSH_VA* arg3); //0x208
};
/* Used in */
