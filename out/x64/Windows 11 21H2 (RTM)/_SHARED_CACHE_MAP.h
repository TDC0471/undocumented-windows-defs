...
struct _SHARED_CACHE_MAP
{
    ...
    ULONG IdealNodeForWriteBehind;                                          //0x224
    ULONG IdealNodeNumber;                                                  //0x228
    struct _LIST_ENTRY VolSharedCacheMapLinks;                              //0x230
    struct _LIST_ENTRY VolLoggedStreamLinks;                                //0x240
    struct _PRIVATE_VOLUME_CACHEMAP* PrivateVolumeCacheMap;                 //0x250
};
/* Used in */
// _CC_PARTITION
// _VACB
