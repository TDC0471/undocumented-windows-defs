...
struct _MI_VISIBLE_PARTITION
{
    ...
    ULONGLONG SlabAllocatorPagesUncharged;                                  //0x348
    ULONGLONG BootSlabPages;                                                //0x350
    ULONGLONG SecureKernelPagesFromNonChargedSlabs;                         //0x358
    ULONGLONG KernelShadowStackPages;                                       //0x360
    ULONG ChargeCommitmentFailures[4];                                      //0x368
    volatile LONG PageFileTraceIndex;                                       //0x378
    struct _MI_PAGEFILE_TRACES PageFileTraces[32];                          //0x380
};
/* Used in */
// _MI_PARTITION
