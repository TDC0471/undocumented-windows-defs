...
struct _HAL_INTEL_ENLIGHTENMENT_INFORMATION
{
    ...
    LONG (*SvmAttachPasidSpace)(ULONGLONG arg1, ULONG arg2, ULONG arg3, ULONG arg4); //0x120
    LONG (*SvmDetachPasidSpace)(ULONGLONG arg1);                            //0x128
    LONG (*SvmEnablePasid)(ULONGLONG arg1, ULONG arg2);                     //0x130
    LONG (*SvmDisablePasid)(ULONGLONG arg1, ULONG arg2);                    //0x138
    ...
    LONG (*SetDeviceAtsEnabled)(struct _EXT_IOMMU_DEVICE_ID* arg1, UCHAR arg2); //0x160
    LONG (*SetDeviceCapabilities)(ULONGLONG arg1, ULONG arg2, ULONG arg3);  //0x168
    LONG (*HvDebuggerPowerHandler)(UCHAR arg1);                             //0x170
    LONG (*SetQpcBias)(ULONGLONG arg1);                                     //0x178
    ULONGLONG (*GetQpcBias)();                                              //0x180
    LONG (*RegisterDeviceId)(struct _EXT_IOMMU_DEVICE_ID* arg1, ULONGLONG arg2); //0x188
    LONG (*UnregisterDeviceId)(ULONGLONG arg1);                             //0x190
    LONG (*AllocateDeviceDomain)(struct _HAL_HV_DMA_CREATE_DOMAIN_INFO* arg1); //0x198
    LONG (*AttachDeviceDomain)(ULONGLONG arg1, struct _HAL_HV_DMA_DOMAIN_INFO* arg2); //0x1a0
    LONG (*DetachDeviceDomain)(ULONGLONG arg1);                             //0x1a8
    LONG (*DeleteDeviceDomain)(struct _HAL_HV_DMA_DOMAIN_INFO* arg1);       //0x1b0
    LONG (*MapDeviceLogicalRange)(struct _HAL_HV_DMA_DOMAIN_INFO* arg1, ULONG arg2, ULONGLONG arg3, ULONGLONG* arg4, ULONGLONG* arg5, UCHAR arg6); //0x1b8
    LONG (*UnmapDeviceLogicalRange)(struct _HAL_HV_DMA_DOMAIN_INFO* arg1, ULONGLONG arg2, ULONGLONG* arg3); //0x1c0
    LONG (*MapDeviceSparsePages)(struct _HAL_HV_DMA_DOMAIN_INFO* arg1, ULONG arg2, ULONGLONG* arg3, ULONGLONG* arg4); //0x1c8
    LONG (*UnmapDeviceSparsePages)(struct _HAL_HV_DMA_DOMAIN_INFO* arg1, ULONGLONG* arg2, ULONGLONG* arg3); //0x1d0
    LONG (*GetDmaGuardEnabled)(UCHAR* arg1);                                //0x1d8
    LONG (*UpdateMicrocode)(VOID* arg1, ULONG arg2, UCHAR arg3);            //0x1e0
    LONG (*GetSintMessage)(UCHAR arg1, VOID** arg2);                        //0x1e8
    LONG (*SetRootFaultReportingReady)();                                   //0x1f0
    LONG (*ConfigureDeviceDomain)(struct _HAL_HV_DMA_DOMAIN_INFO* arg1, struct _HAL_HV_DMA_DOMAIN_CONFIG* arg2); //0x1f8
    LONG (*UnblockDefaultDma)();                                            //0x200
    LONG (*FlushDeviceDomain)(struct _HAL_HV_DMA_DOMAIN_INFO* arg1);        //0x208
    LONG (*FlushDeviceDomainVaList)(struct _HAL_HV_DMA_DOMAIN_INFO* arg1, ULONG arg2, struct _KTB_FLUSH_VA* arg3); //0x210
    LONG (*GetHybridPassthroughReservedRegions)(struct _HAL_HV_DMA_HYBRID_PASSTHROUGH_RESERVED_REGIONS* arg1); //0x218
};
/* Used in */
