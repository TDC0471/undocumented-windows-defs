...
#include <_POP_IRP_WATCHDOG_STATE.h>
...
struct _POP_IRP_DATA
{
    ...
    union
    {
        struct
        {
            ...
            struct _WORK_QUEUE_ITEM PassiveCompletionWorkItem;              //0xf8
        } Device;                                                           //0xd8
        struct
        {
    ...
    enum _POP_PEP_NOTIFY_DEVICE_DSTATE_REASON DStateReason;                 //0x118
    ULONGLONG WatchdogLock;                                                 //0x120
    enum _POP_IRP_WATCHDOG_STATE WatchdogState;                             //0x128
    ULONGLONG BlackboxWatchdogStartTime;                                    //0x130
};
/* Used in */
// _POP_FX_DEVICE
