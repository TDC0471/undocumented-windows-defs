...
union _PPM_POLICY_SETTINGS_MASK
{
    ...
    ULONG ShortThreadRuntimeThreshold:1;                                    //0x4
    ULONG ShortThreadArchClassUpperThreshold:1;                             //0x4
    ULONG ShortThreadArchClassLowerThreshold:1;                             //0x4
    ULONG LongThreadArchClassUpperThreshold:1;                              //0x4
    ULONG LongThreadArchClassLowerThreshold:1;                              //0x4
    ULONG ModuleUnparkPolicy:1;                                             //0x4
    ULONG ComplexUnparkPolicy:1;                                            //0x4
    ULONG SmtUnparkPolicy:1;                                                //0x4
    };
    ULONG Spare:3;                                                          //0x4
};
/* Used in */
