...
struct _PPM_ENGINE_SETTINGS
{
    ...
    UCHAR HeteroDecreaseThreshold[2][64];                                   //0xa1
    UCHAR HeteroIncreaseThreshold[2][64];                                   //0x121
    UCHAR Class0FloorPerformance;                                           //0x1a1
    UCHAR Class1InitialPerformance;                                         //0x1a2
    ULONG ShortThreadRuntimeThreshold;                                      //0x1a4
    enum _KHETERO_CPU_POLICY ThreadPolicies[2];                             //0x1a8
    UCHAR ArchClassLowerThreshold[2];                                       //0x1b0
    UCHAR ArchClassUpperThreshold[2];                                       //0x1b2
    UCHAR ModuleUnparkPolicy;                                               //0x1b4
    UCHAR ComplexUnparkPolicy;                                              //0x1b5
    UCHAR SmtUnparkPolicy;                                                  //0x1b6
};
/* Used in */
// _POP_PPM_PROFILE
