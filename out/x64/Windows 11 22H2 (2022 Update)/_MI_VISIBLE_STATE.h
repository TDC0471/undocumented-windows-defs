...
struct _MI_VISIBLE_STATE
{
    ...
    volatile ULONGLONG NonPagedPoolCommit;                                  //0x98
    volatile ULONGLONG SmallNonPagedPtesCommit;                             //0xa0
    volatile ULONGLONG BootCommit;                                          //0xa8
    volatile ULONGLONG MdlPagesAllocated;                                   //0xb0
    volatile ULONGLONG ContiguousPagesAllocated;                            //0xb8
    ...
    ULONGLONG SystemVaTypeCount[18];                                        //0xa48
    UCHAR SystemVaType[256];                                                //0xad8
    struct _MI_SYSTEM_VA_ASSIGNMENT SystemVaRegions[15];                    //0xbd8
};
/* Used in */
