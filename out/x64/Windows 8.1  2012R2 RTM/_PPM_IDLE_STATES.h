...
struct _PPM_IDLE_STATES
{
    ...
    LONG (*IdleExecute)(VOID* arg1, ULONG arg2, ULONG arg3);                //0x190
    ULONG (*IdlePreselect)(VOID* arg1, struct _PROCESSOR_IDLE_CONSTRAINTS* arg2); //0x198
    ULONG (*IdleTest)(VOID* arg1, ULONG arg2, ULONG arg3);                  //0x1a0
    VOID (*IdleComplete)(VOID* arg1);                                       //0x1a8
    VOID (*IdleCancel)(VOID* arg1, ULONG arg2);                             //0x1b0
    UCHAR (*IdleIsHalted)(VOID* arg1);                                      //0x1b8
    UCHAR (*IdleInitiateWake)(VOID* arg1);                                  //0x1c0
    LONG (*QueryPlatformStateResidency)(VOID* arg1, struct _PROCESSOR_PLATFORM_STATE_RESIDENCIES* arg2); //0x1c8
    struct _PROCESSOR_IDLE_PREPARE_INFO PrepareInfo;                        //0x1d0
    struct _PERFINFO_PPM_STATE_SELECTION* Tracing;                          //0x238
    struct _PPM_IDLE_STATE State[1];                                        //0x240
};
/* Used in */
