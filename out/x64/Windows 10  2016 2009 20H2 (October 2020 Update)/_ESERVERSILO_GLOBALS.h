...
struct _ESERVERSILO_GLOBALS
{
    ...
    struct _UNICODE_STRING NtSystemRoot;                                    //0x420
    struct _UNICODE_STRING SiloRootDirectoryName;                           //0x430
    struct _PSP_STORAGE* Storage;                                           //0x440
    enum _SERVERSILO_STATE State;                                           //0x448
    LONG ExitStatus;                                                        //0x44c
    struct _KEVENT* DeleteEvent;                                            //0x450
    struct _SILO_USER_SHARED_DATA* UserSharedData;                          //0x458
    VOID* UserSharedSection;                                                //0x460
    struct _WORK_QUEUE_ITEM TerminateWorkItem;                              //0x468
    UCHAR IsDownlevelContainer;                                             //0x488
};
/* Used in */
// _EJOB
