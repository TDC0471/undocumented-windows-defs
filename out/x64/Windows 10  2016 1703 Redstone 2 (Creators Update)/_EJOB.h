...
struct _EJOB
{
    ...
    struct _EX_PUSH_LOCK IoControlLock;                                     //0x5d0
    ULONGLONG SiloHardReferenceCount;                                       //0x5d8
    struct _WORK_QUEUE_ITEM RundownWorkItem;                                //0x5e0
    VOID* MemoryPartitionObject;                                            //0x600
    union _JOBOBJECT_ENERGY_TRACKING_STATE EnergyTrackingState;             //0x608
};
/* Used in */
// _DEVICE_MAP
// _EJOB
