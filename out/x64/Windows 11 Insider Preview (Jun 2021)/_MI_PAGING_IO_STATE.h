...
#include <_MI_PAGEFILE_METADATA_LAYOUT.h>
...
struct _MI_PAGING_IO_STATE
{
    ...
    struct _MI_PAGEFILE_METADATA_LAYOUT PageFileMetadata;                   //0xc
    LONG PrefetchSeekThreshold;                                             //0x14
    ULONG InPageSinglePages;                                                //0x18
    ...
    struct _MMPTE* FileOnlyReservePtes;                                     //0xa8
};
/* Used in */
