...
struct _PPM_ENGINE_SETTINGS
{
    ...
    UCHAR HeteroDecreaseThreshold[2048];                                    //0xa1
    UCHAR HeteroIncreaseThreshold[2048];                                    //0x8a1
    UCHAR Class0FloorPerformance;                                           //0x10a1
    UCHAR Class1InitialPerformance;                                         //0x10a2
    ULONG ShortThreadRuntimeThreshold;                                      //0x10a4
    enum _KHETERO_CPU_POLICY ThreadPolicies[2];                             //0x10a8
};
/* Used in */
// _POP_PPM_PROFILE
