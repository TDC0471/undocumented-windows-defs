...
struct _MI_SYSTEM_VA_STATE
{
    ...
    struct _MI_DYNAMIC_BITMAP DynamicBitMapKernelShadowStacks;              //0x58
    struct _MI_DYNAMIC_BITMAP DynamicBitMapSystemPtes;                      //0xa0
    struct _MI_DYNAMIC_BITMAP DynamicBitMapDriverImages[2];                 //0xe8
    struct _MI_DYNAMIC_BITMAP DynamicBitMapPagedPool;                       //0x178
    struct _MI_DYNAMIC_BITMAP DynamicBitMapSystemCache;                     //0x1c0
    struct _MI_DYNAMIC_BITMAP DynamicBitMapSecureNonPagedPool;              //0x208
    ...
    struct _KEVENT FreeSystemCacheVa;                                       //0x370
    ULONGLONG SystemVaLock;                                                 //0x388
    ULONGLONG SystemCacheViewLock;                                          //0x390
    struct _MMWSL_INSTANCE SystemWorkingSetList[8];                         //0x398
