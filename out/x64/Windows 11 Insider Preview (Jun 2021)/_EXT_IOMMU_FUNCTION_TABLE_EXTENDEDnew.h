...
struct _EXT_IOMMU_FUNCTION_TABLE_EXTENDED
{
    ...
    VOID (*SetDevicePasidTable)(VOID* arg1, ULONGLONG arg2, struct _IOMMU_PASID_TABLE_OBJECT* arg3); //0x10
    LONG (*GrowPasidTable)(VOID* arg1, struct _IOMMU_PASID_TABLE_OBJECT* arg2, ULONG arg3); //0x18
    LONG (*SetPasidAddressSpace)(VOID* arg1, struct _IOMMU_PASID_TABLE_OBJECT* arg2, ULONG arg3, ULONGLONG arg4); //0x20
    VOID (*FlushTb)(VOID* arg1, ULONG arg2, ULONG arg3, struct _LIST_ENTRY* arg4, ULONG arg5, struct _KTB_FLUSH_VA* arg6); //0x28
    VOID (*FlushDeviceTbOnly)(VOID* arg1, ULONGLONG arg2, ULONG arg3);      //0x30
    VOID (*DismissPageFault)(VOID* arg1, VOID* arg2, LONG arg3, UCHAR arg4, struct _IOMMU_PAGE_FAULT_PRIVATE_DATA* arg5); //0x38
    ULONG (*GetPageFault)(VOID* arg1, VOID* arg2, ULONG* arg3, ULONGLONG* arg4, WCHAR* arg5, struct _IOMMU_PAGE_FAULT_PRIVATE_DATA* arg6, VOID** arg7, ULONGLONG* arg8); //0x40
