...
struct _ESERVERSILO_GLOBALS
{
    ...
    struct _EX_TIMEZONE_STATE* ExTimeZoneState;                             //0x4e0
    struct _UNICODE_STRING NtSystemRoot;                                    //0x4e8
    struct _UNICODE_STRING SiloRootDirectoryName;                           //0x4f8
    struct _PSP_STORAGE* Storage;                                           //0x508
    enum _SERVERSILO_STATE State;                                           //0x510
    LONG ExitStatus;                                                        //0x514
    struct _KEVENT* DeleteEvent;                                            //0x518
    struct _SILO_USER_SHARED_DATA* UserSharedData;                          //0x520
    VOID* UserSharedSection;                                                //0x528
    struct _WORK_QUEUE_ITEM TerminateWorkItem;                              //0x530
    UCHAR IsDownlevelContainer;                                             //0x550
};
/* Used in */
// _EJOB
