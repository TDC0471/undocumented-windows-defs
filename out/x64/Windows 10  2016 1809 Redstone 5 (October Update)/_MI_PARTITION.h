...
struct _MI_PARTITION
{
    ...
    struct _MI_PARTITION_COMMIT Commit;                                     //0x1900
    struct _MI_PARTITION_ZEROING Zeroing;                                   //0x1980
    struct _MI_PAGE_COMBINING_SUPPORT PageCombine;                          //0x19e8
    VOID* WorkingSetControl;                                                //0x1b70
    struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;           //0x1b78
    struct _MI_VISIBLE_PARTITION Vp;                                        //0x1bc0
};
/* Used in */
