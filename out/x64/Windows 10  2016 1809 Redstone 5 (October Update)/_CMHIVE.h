...
struct _CMHIVE
{
    ...
    UCHAR* FlushLogEntry;                                                   //0x6a8
    ULONG FlushLogEntrySize;                                                //0x6b0
    ULONG FlushHiveTruncated;                                               //0x6b4
    UCHAR FlushBaseBlockDirty;                                              //0x6b8
    ...
    union
    {
        ULONG FlushFlags;                                                   //0x10b8
        struct
        {
            ULONG FlushActive:1;                                            //0x10b8
            ULONG ReconcileActive:1;                                        //0x10b8
            ULONG PrimaryFilePurged:1;                                      //0x10b8
            ULONG DiskFileBad:1;                                            //0x10b8
        };
    };
    ULONG PrimaryFileSizeBeforeLastFlush;                                   //0x10bc
    volatile LONG ReferenceCount;                                           //0x10c0
    LONG UnloadHistoryIndex;                                                //0x10c4
    ULONG UnloadHistory[128];                                               //0x10c8
    ULONG BootStart;                                                        //0x12c8
    ULONG UnaccessedStart;                                                  //0x12cc
    ULONG UnaccessedEnd;                                                    //0x12d0
    ULONG LoadedKeyCount;                                                   //0x12d4
    volatile ULONG HandleClosePending;                                      //0x12d8
    struct _EX_PUSH_LOCK HandleClosePendingEvent;                           //0x12e0
    UCHAR FinalFlushSucceeded;                                              //0x12e8
    struct _CMP_VOLUME_CONTEXT* VolumeContext;                              //0x12f0
};
/* Used in */
// _CM_RM
// _CM_TRANS
