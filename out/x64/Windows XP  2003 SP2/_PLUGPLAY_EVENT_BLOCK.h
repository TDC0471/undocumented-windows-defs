...
struct _PLUGPLAY_EVENT_BLOCK
{
    ...
    union
    {
        struct
        {
            ...
            USHORT SymbolicLinkName[1];                                     //0x40
        } DeviceClass;                                                      //0x30
        struct
        {
            USHORT DeviceIds[1];                                            //0x30
        } TargetDevice;                                                     //0x30
        struct
        {
            USHORT DeviceId[1];                                             //0x30
        } InstallDevice;                                                    //0x30
        struct
        {
            VOID* NotificationStructure;                                    //0x30
            USHORT DeviceIds[1];                                            //0x38
        ...
        struct
        {
            ...
            USHORT DeviceIdVetoNameBuffer[1];                               //0x34
