...
struct _BUS_HANDLER
{
    ...
    ULONG (*GetInterruptVector)(struct _BUS_HANDLER* arg1, struct _BUS_HANDLER* arg2, ULONG arg3, ULONG arg4, UCHAR* arg5, ULONGLONG* arg6); //0x68
    UCHAR (*TranslateBusAddress)(struct _BUS_HANDLER* arg1, struct _BUS_HANDLER* arg2, union _LARGE_INTEGER arg3, ULONG* arg4, union _LARGE_INTEGER* arg5); //0x70
    VOID* Spare1;                                                           //0x78
    VOID* Spare2;                                                           //0x80
    VOID* Spare3;                                                           //0x88
    VOID* Spare4;                                                           //0x90
