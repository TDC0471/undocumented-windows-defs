...
struct _ARBITER_INSTANCE
{
    ...
    VOID* Extension;                                                        //0x128
    struct _DEVICE_OBJECT* BusDeviceObject;                                 //0x130
    VOID* ConflictCallbackContext;                                          //0x138
    UCHAR (*ConflictCallback)(VOID* arg1, struct _RTL_RANGE* arg2);         //0x140
    WCHAR PdoDescriptionString[336];                                        //0x148
    CHAR PdoSymbolicNameString[672];                                        //0x3e8
    WCHAR PdoAddressString[1];                                              //0x688
};
/* Used in */
// _ARBITER_INSTANCE
