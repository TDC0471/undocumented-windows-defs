...
struct _KTM
{
    ...
    VOID* TmRmHandle;                                                       //0x298
    struct _KRESOURCEMANAGER* TmRm;                                         //0x2a0
    struct _KEVENT LogFullNotifyEvent;                                      //0x2a8
    struct _WORK_QUEUE_ITEM CheckpointWorkItem;                             //0x2c0
    union _CLS_LSN CheckpointTargetLsn;                                     //0x2e0
    struct _WORK_QUEUE_ITEM LogFullCompletedWorkItem;                       //0x2e8
    struct _ERESOURCE LogWriteResource;                                     //0x308
    ULONG LogFlags;                                                         //0x370
    LONG LogFullStatus;                                                     //0x374
    LONG RecoveryStatus;                                                    //0x378
};
/* Used in */
// _KRESOURCEMANAGER
// _KTRANSACTION
