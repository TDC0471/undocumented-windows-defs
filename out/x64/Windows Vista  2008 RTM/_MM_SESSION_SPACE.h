...
struct _MM_SESSION_SPACE
{
    ...
    struct _MMPTE SessionPteFreeHead;                                       //0x1d90
    struct _MI_SYSTEM_PTE_TYPE SystemPteInfo;                               //0x1d98
    VOID* PoolTrackTableExpansion;                                          //0x1db8
    ULONGLONG PoolTrackTableExpansionSize;                                  //0x1dc0
    VOID* PoolTrackBigPages;                                                //0x1dc8
    ULONGLONG PoolTrackBigPagesSize;                                        //0x1dd0
};
