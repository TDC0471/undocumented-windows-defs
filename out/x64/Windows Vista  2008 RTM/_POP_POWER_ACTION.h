...
struct _POP_POWER_ACTION
{
    ...
    struct _POP_DISPLAY_RESUME_CONTEXT* DisplayResumeContext;               //0x40
    struct _POP_HIBER_CONTEXT* HiberContext;                                //0x48
    ULONGLONG WakeTime;                                                     //0x50
    ULONGLONG SleepTime;                                                    //0x58
    struct _SYSTEM_POWER_STATE_CONTEXT SystemContext;                       //0x60
    struct SYSTEM_POWER_CAPABILITIES FilteredCapabilities;                  //0x64
};
