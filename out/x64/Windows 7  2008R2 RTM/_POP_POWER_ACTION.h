...
struct _POP_POWER_ACTION
{
    ...
    ULONGLONG ProgrammedRTCTime;                                            //0x58
    UCHAR WakeOnRTC;                                                        //0x60
    struct _DIAGNOSTIC_BUFFER* WakeTimerInfo;                               //0x68
    struct SYSTEM_POWER_CAPABILITIES FilteredCapabilities;                  //0x70
};
