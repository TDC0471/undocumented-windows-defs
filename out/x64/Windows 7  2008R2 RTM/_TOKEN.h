...
struct _TOKEN
{
    ...
    struct _SEP_LOGON_SESSION_REFERENCES* LogonSession;                     //0xd0
    struct _LUID OriginatingLogonSession;                                   //0xd8
    struct _SID_AND_ATTRIBUTES_HASH SidHash;                                //0xe0
    struct _SID_AND_ATTRIBUTES_HASH RestrictedSidHash;                      //0x1f0
    struct _AUTHZBASEP_SECURITY_ATTRIBUTES_INFORMATION* pSecurityAttributes; //0x300
    ULONGLONG VariablePart;                                                 //0x308
};
