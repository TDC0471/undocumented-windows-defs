...
struct _VF_TARGET_VERIFIED_DRIVER_DATA
{
    ...
    volatile ULONG PeakPagedPoolAllocations;                                //0x58
    volatile ULONG PeakNonPagedPoolAllocations;                             //0x5c
    volatile ULONGLONG PagedBytes;                                          //0x60
    volatile ULONGLONG NonPagedBytes;                                       //0x68
    volatile ULONGLONG PeakPagedBytes;                                      //0x70
    volatile ULONGLONG PeakNonPagedBytes;                                   //0x78
