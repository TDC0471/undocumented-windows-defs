...
struct _MI_PARTITION
{
    ...
    struct _MI_PARTITION_MODWRITES Modwriter;                               //0x158
    ...
    struct _MI_PAGE_COMBINING_SUPPORT PageCombine;                          //0x1428
    VOID* WorkingSetControl;                                                //0x15b0
    struct _MMWORKING_SET_EXPANSION_HEAD WorkingSetExpansionHead;           //0x15b8
    struct _MI_VISIBLE_PARTITION Vp;                                        //0x1600
};
/* Used in */
