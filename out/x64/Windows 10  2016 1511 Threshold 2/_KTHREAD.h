...
struct _KTHREAD
{
    ...
    union
    {
        struct
        {
            ...
            ULONG ThreadFlagsSpare0:1;                                      //0x78
            ...
            ULONG CommitFailTerminateRequest:1;                             //0x78
            ULONG ProcessStackCountDecremented:1;                           //0x78
            ULONG ThreadFlagsSpare:5;                                       //0x78
    ...
    volatile SHORT KeReferenceCount;                                        //0x588
    UCHAR AbOrphanedEntrySummary;                                           //0x58a
    UCHAR AbOwnedEntryCount;                                                //0x58b
