...
struct _MI_SYSTEM_INFORMATION
{
    ...
    struct _MI_PROCESS_STATE Processes;                                     //0x4d0
    struct _MI_HARDWARE_STATE Hardware;                                     //0x530
    ...
    struct _MI_SHUTDOWN_STATE Shutdowns;                                    //0xac0
    struct _MI_ERROR_STATE Errors;                                          //0xb40
    ...
    struct _MI_RESAVAIL_TRACKER ResTrack;                                   //0x11c0
