...
struct PO_MEMORY_IMAGE
{
    ...
    ULONG FirmwareRuntimeInformationPages;                                  //0xd8
    ULONGLONG FirmwareRuntimeInformation[1];                                //0xe0
    ULONG NoBootLoaderLogPages;                                             //0xe8
    ULONGLONG BootLoaderLogPages[8];                                        //0xf0
    ULONG NotUsed;                                                          //0x130
    ULONG ResumeContextCheck;                                               //0x134
    ULONG ResumeContextPages;                                               //0x138
};
/* Used in */
// _POP_HIBER_CONTEXT
