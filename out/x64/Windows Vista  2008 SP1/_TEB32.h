...
struct _TEB32
{
    ...
    UCHAR SpareBool0;                                                       //0xf74
    UCHAR SpareBool1;                                                       //0xf75
    UCHAR SpareBool2;                                                       //0xf76
    ...
    union
    {
        ...
        struct
        {
            USHORT DbgSafeThunkCall:1;                                      //0xfca
            USHORT DbgInDebugPrint:1;                                       //0xfca
            USHORT DbgHasFiberData:1;                                       //0xfca
            USHORT DbgSkipThreadAttach:1;                                   //0xfca
            USHORT DbgWerInShipAssertCode:1;                                //0xfca
            USHORT DbgRanProcessInit:1;                                     //0xfca
            USHORT DbgClonedThread:1;                                       //0xfca
            USHORT DbgSuppressDebugMsg:1;                                   //0xfca
            USHORT RtlDisableUserStackWalk:1;                               //0xfca
            USHORT RtlExceptionAttached:1;                                  //0xfca
            USHORT SpareSameTebBits:6;                                      //0xfca
        };
    };
    ...
    ULONG ProcessRundown;                                                   //0xfdc
    ULONGLONG LastSwitchTime;                                               //0xfe0
    ULONGLONG TotalSwitchOutTime;                                           //0xfe8
    union _LARGE_INTEGER WaitReasonBitMap;                                  //0xff0
};
