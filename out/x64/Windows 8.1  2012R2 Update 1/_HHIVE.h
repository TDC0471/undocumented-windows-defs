...
struct _HHIVE
{
    ...
    ULONG LogFileSizeCap;                                                   //0x9c
    UCHAR LogDataPresent[2];                                                //0xa0
    UCHAR PrimaryFileValid;                                                 //0xa2
    UCHAR BaseBlockDirty;                                                   //0xa3
    union
    {
        struct
        {
            USHORT FirstLogFile:3;                                          //0xa4
            USHORT SecondLogFile:3;                                         //0xa4
            USHORT HeaderRecovered:1;                                       //0xa4
            USHORT LegacyRecoveryIndicated:1;                               //0xa4
            USHORT RecoveryInformationReserved:8;                           //0xa4
        };
        USHORT RecoveryInformation;                                         //0xa4
    };
    UCHAR LogEntriesRecovered[2];                                           //0xa6
    ULONG RefreshCount;                                                     //0xa8
    ULONG StorageTypeCount;                                                 //0xac
    ULONG Version;                                                          //0xb0
    struct _DUAL Storage[2];                                                //0xb8
};
/* Used in */
// _CMHIVE
