...
struct _PPM_ENGINE_SETTINGS
{
    ...
    UCHAR HeteroDecreaseThreshold[1280];                                    //0x9d
    UCHAR HeteroIncreaseThreshold[1280];                                    //0x59d
    UCHAR Class0FloorPerformance;                                           //0xa9d
    UCHAR Class1InitialPerformance;                                         //0xa9e
    enum _KHETERO_CPU_POLICY ThreadPolicies[2];                             //0xaa0
};
/* Used in */
// _POP_PPM_PROFILE
