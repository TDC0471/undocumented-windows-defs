...
struct _POP_POWER_ACTION
{
    ...
    struct _KDPC WatchdogDpc;                                               //0x118
    struct _KTIMER WatchdogTimer;                                           //0x158
    UCHAR WatchdogInitialized;                                              //0x198
    enum _POP_POWER_ACTION_WATCHDOG_STATE WatchdogState;                    //0x19c
    ULONGLONG WatchdogStartTime;                                            //0x1a0
    struct _KTHREAD* ActionWorkerThread;                                    //0x1a8
    struct _KTHREAD* PromoteActionWorkerThread;                             //0x1b0
    struct _KTHREAD* UnlockAfterSleepWorkerThread;                          //0x1b8
};
